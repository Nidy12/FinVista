...
const Hero = () => (
    <section id="home" className={`flex overflow-x-hidden md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div>
        <img src={robot} alt='billing' className='overflow-x-hidden w-[100%] h-[100%] relative z-[5]'/>
